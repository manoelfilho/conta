...
class ViewController2: UIViewController {
    ...
    private lazy var labelFooter: UILabel = {
        let labelFooter: UILabel = .textLabel(text: "on_boarding_text_page_two".localized(), fontSize: 20, numberOfLines: 4, color: UIColor(named: K.colorText)!, type: .Light)
